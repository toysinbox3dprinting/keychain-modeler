...
// src/core/vendor/csg/src/api/primitives2d-api.js
var require_primitives2d_api = __commonJS({
  "src/core/vendor/csg/src/api/primitives2d-api.js"(exports, module) {
    "use strict";
    var { CAG } = require_csg();
    var { fromPoints } = require_CAGFactories();
    function square() {
...
// src/core/vendor/csg/src/api/ops-transformations.js
var require_ops_transformations = __commonJS({
  "src/core/vendor/csg/src/api/ops-transformations.js"(exports, module) {
    "use strict";
    var Matrix4 = require_Matrix4();
    var Plane = require_Plane();
    var Vector3 = require_Vector3();
    var { union } = require_ops_booleans();
    var { fromPoints } = require_CAGFactories();
    var { isCAG } = require_utils();
    ...
    function hull() {
      ...
      let ConvexHullPoint = function(i, a2, d) {
        this.index = i;
        this.angle = a2;
        this.distance = d;
      ...
      let ConvexHull = function() {
        ...
        this.ccw = function(p1, p2, p3) {
          let ccw = (this.points[p2].x - this.points[p1].x) * (this.points[p3].y - this.points[p1].y) - (this.points[p2].y - this.points[p1].y) * (this.points[p3].x - this.points[p1].x);
          if (ccw < 1e-5) {
            return 0;
          }
          return ccw;
        };
        this.angle = function(o, a2) {
          return Math.atan2(this.points[a2].y - this.points[o].y, this.points[a2].x - this.points[o].x);
        };
        this.distance = function(a2, b) {
          return (this.points[b].x - this.points[a2].x) * (this.points[b].x - this.points[a2].x) + (this.points[b].y - this.points[a2].y) * (this.points[b].y - this.points[a2].y);
        };
      ...
      let hull2 = new ConvexHull();
      hull2.compute(pts);
      let indices = hull2.getIndices();
...
// src/core/vendor/csg/src/api/primitives3d-api.js
var require_primitives3d_api = __commonJS({
  "src/core/vendor/csg/src/api/primitives3d-api.js"(exports, module) {
    "use strict";
    var { CSG } = require_csg();
    var { circle } = require_primitives2d_api();
    var { rotate_extrude } = require_ops_extrusions();
    var { translate, scale } = require_ops_transformations();
    var Polygon3 = require_Polygon3();
    var Vector3 = require_Vector3();
    var Vertex3 = require_Vertex3();
    function cube(params) {
      ...
      if (params && params.size && params.size.length) v = params.size;
      if (params && params.size && !params.size.length) size = params.size;
      if (params && typeof params !== "object") size = params;
      ...
      offset = [x / 2, y / 2, z / 2];
      let object = round ? CSG.roundedCube({ radius: [x / 2, y / 2, z / 2], roundradius: radius, resolution: fn }) : CSG.cube({ radius: [x / 2, y / 2, z / 2] });
    ...
    function geodesicSphere(params) {
      ...
      let geodesicSubDivide = function(p, fn2, offset2) {
        let p1 = p[0];
        let p2 = p[1];
        let p3 = p[2];
        let n = offset2;
        ...
        let f2 = [];
        for (let i = 0; i < fn2; i++) {
          for (let j = 0; j < fn2 - i; j++) {
            let t0 = i / fn2;
            let t1 = (i + 1) / fn2;
            let s0 = j / (fn2 - i);
            let s1 = (j + 1) / (fn2 - i);
            let s2 = fn2 - i - 1 ? j / (fn2 - i - 1) : 1;
            let q = [];
            q[0] = mix3(mix3(p1, p2, s0), p3, t0);
            q[1] = mix3(mix3(p1, p2, s1), p3, t0);
            q[2] = mix3(mix3(p1, p2, s2), p3, t1);
            for (let k = 0; k < 3; k++) {
              let r2 = Math.sqrt(q[k][0] * q[k][0] + q[k][1] * q[k][1] + q[k][2] * q[k][2]);
              for (let l = 0; l < 3; l++) {
                q[k][l] /= r2;
              }
            }
    ...
    function cylinder(params) {
      ...
      if (params && (params.start && params.end)) {
        object = round ? CSG.roundedCylinder({ start: params.start, end: params.end, radiusStart: r1, radiusEnd: r2, resolution: fn }) : CSG.cylinder({ start: params.start, end: params.end, radiusStart: r1, radiusEnd: r2, resolution: fn });
      } else {
        object = round ? CSG.roundedCylinder({ start: [0, 0, 0], end: [0, 0, h], radiusStart: r1, radiusEnd: r2, resolution: fn }) : CSG.cylinder({ start: [0, 0, 0], end: [0, 0, h], radiusStart: r1, radiusEnd: r2, resolution: fn });
        let r = r1 > r2 ? r1 : r2;
        if (params && params.center && params.center.length) {
...
// src/core/vendor/csg/src/api/color.js
var require_color = __commonJS({
  "src/core/vendor/csg/src/api/color.js"(exports, module) {
    "use strict";
    var cssColors = {
    ...
    function color(color2) {
      ...
      if (typeof color2 === "string") {
        color2 = css2rgb(color2);
      }
      if (Number.isFinite(a[i])) {
        color2 = color2.concat(a[i]);
        i++;
      }
    ...
    function rgb2html(r, g, b) {
      ...
      let s = "#" + Number(16777216 + r * 255 * 65536 + g * 255 * 256 + b * 255).toString(16).substring(1, 7);
      return s;
    }
    module.exports = {
      css2rgb,
...
// src/core/vendor/csg/src/api/maths.js
var require_maths = __commonJS({
  "src/core/vendor/csg/src/api/maths.js"(exports, module) {
    "use strict";
    function sin(a) {
    ...
    function rands(min2, max2, vn, seed) {
      var v = new Array(vn);
      for (var i = 0; i < vn; i++) {
        v[i] = Math.random() * (max2 - min2) + min2;
      }
    }
    function log(a) {
      return Math.log(a);
...
// src/core/vendor/csg/src/fonts/single-line/hershey/simplex.js
var require_simplex = __commonJS({
  "src/core/vendor/csg/src/fonts/single-line/hershey/simplex.js"(exports, module) {
    "use strict";
    module.exports = {
      height: 14,
      32: [16],
...
// src/core/vendor/csg/src/api/text.js
var require_text = __commonJS({
  "src/core/vendor/csg/src/api/text.js"(exports, module) {
    "use strict";
...
// src/core/vendor/csg/src/api/debug.js
var require_debug = __commonJS({
  "src/core/vendor/csg/src/api/debug.js"(exports, module) {
    "use strict";
    function echo() {
...
// src/core/vendor/csg/src/api/log.js
var require_log = __commonJS({
  "src/core/vendor/csg/src/api/log.js"(exports, module) {
    "use strict";
    function log(txt) {
...
// src/core/vendor/csg/src/api/index.js
var require_api = __commonJS({
  "src/core/vendor/csg/src/api/index.js"(exports, module) {
    "use strict";
    var primitives3d = require_primitives3d_api();
    var primitives2d = require_primitives2d_api();
    var booleanOps = require_ops_booleans();
    var transformations = require_ops_transformations();
    var extrusions = require_ops_extrusions();
    var color = require_color();
    var maths = require_maths();
    var text = require_text();
    var { echo } = require_debug();
    var { CAG, CSG } = require_csg();
    var { log } = require_log();
    var exportedApi = {
      csg: { CAG, CSG },
      primitives2d,
...
var require_api2 = __commonJS({
  "src/core/vendor/csg/api.js"(exports, module) {
    var api = require_api();
    module.exports = api;
  }
});
